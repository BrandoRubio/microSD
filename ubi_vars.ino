...
unsigned long timer_upload; //Temporizador que lleva el tiempo de vida del programa
...
/*
unsigned long previousMillisConductivity = 0;
unsigned long intervalConductivity = 10000;*/
...
//const int interval_upload = 1000;
